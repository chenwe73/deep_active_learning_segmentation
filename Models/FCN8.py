...
VGG_Weights_path = file_path+"/../../h5/vgg16_weights_th_dim_ordering_th_kernels.h5"
...
def FCN8( nClasses ,  input_height=224, input_width=224 , vgg_level=3):
    ...
    x = Flatten(name='flatten_cl')(x)
    x = Dense(4096, activation='relu', name='fc1_cl')(x)
    x = Dense(4096, activation='relu', name='fc2_cl')(x)
    x = Dense( 1000 , activation='softmax', name='predictions_cl')(x)
